            ...
            <div className="grid md:grid-cols-2 items-center gap-6">
              <div className="ltr:md:text-left rtl:md:text-right text-center">
                <p className="mb-0 text-gray-300 font-medium">
                  ©2024 JobLeLo. Design &amp; Develop with{" "}
              ...
              <ul className="list-none ltr:md:text-right rtl:md:text-left text-center space-x-0.5">
                <li className="inline">
                  <Link
                    className="btn btn-icon btn-sm border-2 border-blue-800 dark:border-blue-700 rounded-md hover:border-blue-600 dark:hover:border-blue-600 hover:bg-blue-600 dark:hover:bg-blue-600 text-blue-900 hover:text-white"
                    target="_blank"
                  >
                    <svg
                      stroke="currentColor"
