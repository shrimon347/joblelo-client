      ...
      <section className="  mx-auto py-20 w-full table relative  bg-top bg-no-repeat bg-cover">
        ...
        <div className=" mx-auto relative max-w-7xl">
          <div className="grid grid-cols-1 text-center">
            ...
            <Link
              className="lightbox text-white size-20 rounded-full shadow-lg dark:shadow-gray-800 inline-flex items-center justify-center bg-blue-900 dark:bg-slate-900 mx-auto mt-10"
              href="/"
            >Play</Link>
          </div>
        </div>
